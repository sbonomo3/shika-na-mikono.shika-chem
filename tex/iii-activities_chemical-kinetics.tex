...
\subsection{Effect of Temperature on \hfill \\ Reaction Rate} \index{Temperature! effect on reaction rate}
...
\subsection{Effect of Concentration on \hfill \\ Reaction Rate} \index{Concentration! effect on reaction rate} % PIC!!! syringes stuck in bottles
...
\subsection{Effect of Surface Area on \hfill \\ Reaction Rate} \index{Surface area! effect on reaction rate}
...
\subsection{Effect of a Catalyst on \hfill \\ Reaction Rate} \index{Catalysts!}
