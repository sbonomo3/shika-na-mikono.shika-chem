...
%\item[Theory:]{The glass allows light rays to enter through it, but reflects some of its energy back into the bucket as it tries to escape. Hence the light and heat are trapped inside the bucket and the water temperature increases. This is the same way in which the ozone layer in our atmosphere works. It protects }
%\item[Applications:]{}
%\item[Notes:]{}
%\end{description*}
