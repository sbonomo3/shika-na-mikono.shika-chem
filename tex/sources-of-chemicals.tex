\chapter{Sources of Chemicals} \index{Chemicals! sources of}
...
\section[Ammonium hydroxide solution]{Ammonium hydroxide \hfill \\ solution}
%\label{sec:}
See \nameref{sec:ammoniasol}.

\section[Ammonium carbonate, chloride, and nitrate]{Ammonium carbonate, \hfill \\ chloride, and nitrate}
%\label{sec:}
...
\section[Barium chloride and barium nitrate]{Barium chloride and \hfill \\ barium nitrate}
%\label{sec:}
...
Use: food tests (for reducing and non reducing sugars)\\
...
\section[Calcium ammonium nitrate]{Calcium ammonium \hfill \\ nitrate}
%\label{sec:}
Other names: \ce{CAN}\\
...
\section[Calcium chloride and calcium nitrate]{Calcium chloride and \hfill \\ calcium nitrate}
%\label{sec:}
Description: highly deliquescent colorless crystals 
(poorly sealed containers often turn into thick liquid)\\
...
\section[Copper chloride and copper nitrate]{Copper chloride and \hfill \\ copper nitrate}
%\label{sec:}
...
\section[Potassium aluminum sulfate]{Potassium aluminum \hfill \\ sulfate}
\label{sec:potalsulf}
...
\section[Potassium hexacyanoferrate (II)]{Potassium \hfill \\ hexacyanoferrate (II)}
%\label{sec:}
...
\section[Potassium hexacyanoferrate (III)]{Potassium \hfill \\ hexacyanoferrate (III)}
%\label{sec:}
...
\section[Potassium manganate (VII)]{Potassium manganate \hfill \\ (VII)}
%\label{sec:}
Formula: \ce{KMnO4}\\
...
decolorization confirms chlorides
% -- see \nameref{cha:qualana}
...
\section[Sodium hydrogen carbonate]{Sodium hydrogen \hfill \\ carbonate}
%\label{sec:}
Formula: \ce{NaHCO3}\\
Description: white powder, 
...
\section[Sodium hypochlorite solution]{Sodium hypochlorite \hfill \\ solution}
%\label{sec:}
